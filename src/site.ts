...
// Sitemap lastmod moved to src/lastmod.ts on 2026-08-21: the hand-maintained map
// here had drifted so far that ~48% of sitemap URLs misreported by 3+ months.
// It is now generated from git history by scripts/refresh-lastmod.mjs.
