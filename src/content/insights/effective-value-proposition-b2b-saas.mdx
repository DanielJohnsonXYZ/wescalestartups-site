...
The value proposition explains *how* the product works instead of *why it matters*. "AI-powered contract analysis" is a mechanism. "Contract review that took six hours now takes twelve minutes" is a transformation.

The buyer doesn't need to understand your NLP pipeline to buy the outcome, and describing the pipeline in the headline actively gets in the way, because now they have to do the translation work themselves. Most won't bother.
